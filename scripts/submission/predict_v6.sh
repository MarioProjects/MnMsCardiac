...
# Usage: ./scripts/submission/predict_v6.sh "<input_data_folder_path>" "<output_results_folder>"
# Optional Usage Overlays: ./scripts/submission/predict_v6.sh "<input_data_folder_path>" "<output_results_folder>" "<overlays_out_folder"

gpu="0"
dataset="mnms_test"

model="resnet34_unet_scratch"
ckpt="/evaluationSubmission/segmentator_swa_v6.pt"
