...
model_path="results/submission_v2/segmentation/$parent_dir/foldBy_${fold_system}/da${data_augmentation}_scheduler_${scheduler}"
...
python3 -u train_segmentation.py --gpu $gpu --output_dir $model_path --epochs $epochs \
  ...
  --criterion $criterion --weights_criterion $weights_criterion --dataset $dataset --scheduler_steps 27 35 \
